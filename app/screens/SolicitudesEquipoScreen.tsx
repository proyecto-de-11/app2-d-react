...
export default function SolicitudesEquipoScreen() {
    ...
    const handleResponderInvitacion = async (invitacionId: number, nuevoEstado: 'ACEPTADA' | 'RECHAZADA',usuario:number) => {
        if (!usuarioActualId) {
            ...
            {item.estado === 'PENDIENTE' && (
                <View style={styles.actionsContainer}>
                    <TouchableOpacity
                        ...
                        onPress={() => handleResponderInvitacion(item.id, 'RECHAZADA',item.usuarioRemitenteId)}
                    >
                        <Text style={styles.rejectButtonText}>Rechazar</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={[styles.actionButton, styles.acceptButton]}
                        onPress={() => handleResponderInvitacion(item.id, 'ACEPTADA',item.usuarioRemitenteId)}
                    >
                        <LinearGradient
